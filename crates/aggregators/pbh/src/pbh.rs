...
const PBH_AGGREGATOR_ADDRESS: Address = address!("39911B3242e952d86270857Bc8eFC3FcE8d84abe");
// TODO(pbh): verify these values with onchain data
const PBH_AGGREGATOR_FIXED_GAS: u128 = 50_000;
const PBH_AGGREGATOR_VARIABLE_GAS: u128 = 10_000;
...
// TIMESTAMP + ECDSA_SIGNATURE + PBH_PROOF_LENGTH bytes of 0xFF = 12 + 65 + 352 = 429
static PBH_DUMMY_UO_SIG: Bytes = bytes!("");
